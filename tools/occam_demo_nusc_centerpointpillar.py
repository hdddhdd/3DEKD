...
def parse_config():
    ...
    parser.add_argument('--attrmap_save_dir', type=str, default='attrmap_centerpointpillar_nusc',
                        help='Directory to save attribution maps')
    parser.add_argument('--pcl_save_dir', type=str, default='pcl_centerpointpillar_nusc',
